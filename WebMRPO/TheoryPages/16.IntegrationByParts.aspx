        ...
        <div id="workspace">
            ...
            <div id="content">
                ...
                <div id="text">
                    ...
                    <p align="justify">
                        <b><span style="color: brown">Теорема: </span></b>пусть функции
                        <img src="https://latex.codecogs.com/gif.latex?U&space;=&space;U(x)&space;,&space;V=V(x)" title="U = U(x) , V=V(x)" />
                        непрерывно дифференцируемы на отрезке
                        <img src="https://latex.codecogs.com/gif.latex?[a,b]" title="[a,b]" />, тогда имеет место равенство:
                    </p>
                    <a>
                        <img src="https://latex.codecogs.com/gif.latex?\int_{a}^{b}UdV=U\cdot&space;V|_{a}^{b}&space;-&space;\int_{a}^{b}VdU" title="\int_{a}^{b}UdV=U\cdot V|_{a}^{b} - \int_{a}^{b}VdU" /></a>
                    <br align="justify"><b><span style="color: brown">Доказательство: </span></b>так как
                        <img src="https://latex.codecogs.com/gif.latex?(U\cdot&space;V)'=U\cdot&space;V'&plus;U'\cdot&space;V" title="(U\cdot V)'=U\cdot V'+U'\cdot V" />
                        , то функция 
                   <img src="https://latex.codecogs.com/gif.latex?U\cdot&space;V" title="U\cdot V" />
                        является первообразной для функции
                        <img src="https://latex.codecogs.com/gif.latex?U\cdot&space;V'&plus;U'\cdot&space;V" title="U\cdot V'+U'\cdot V" />. Тогда по теореме Ньютона-Лейбница 
                    имеем:</br>
                    <a>
