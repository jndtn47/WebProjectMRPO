                ...
                <div id="content">
                    ...
                    <div id="text">
                        <body>
                            ...
                            <div>Пусть существует предел функции t = g(x) при
                                ...
                                <img src="https://latex.codecogs.com/gif.latex?t_{0}" title="t_{0}" />:</div>
                            <div>
                            ...
                            <div>Здесь точка x0 может быть конечной или бесконечно удаленной:
                                <img src="https://latex.codecogs.com/gif.latex?x_{0}" title="x_{0}" />
                                принадлежит к множеству действительных чисел</div>
                            <div>И пусть функция f(t)  непрерывна в точке
                                <img src="https://latex.codecogs.com/gif.latex?t_{0}" title="t_{0}" />.</div>
                            <div>Тогда существует предел сложной функции f(g(x)), и он равен f(t0):</div>
                            <div>
                                <img src="https://latex.codecogs.com/gif.latex?\lim_{x\rightarrow&space;x_{0}}f(g(t))=f(\lim_{x\rightarrow&space;x_{0}}g(t))=f(t_{0})" title="\lim_{x\rightarrow x_{0}}f(g(t))=f(\lim_{x\rightarrow x_{0}}g(t))=f(t_{0})" /></div>
                        </body>
                    </div>
                </div>
                <div id="footer"></div>
