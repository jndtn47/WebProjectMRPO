...
<div id="text">
    <body>
        ...
        <div>Для того, чтобы функция f(x), определенная на некоторой проколотой окрестности конечной или бесконечно удаленной точки x0, имела в этой точке конечный предел, необходимо и достаточно, чтобы для любого ε > 0 существовала такая проколотая окрестность <img src="https://latex.codecogs.com/gif.latex?\dot{U}(x_{0},\delta&space;_{\varepsilon&space;})" title="\dot{U}(x_{0},\delta _{\varepsilon })" /> точки x0, что для любых точек <img src="https://latex.codecogs.com/gif.latex?x'" title="x'" />, принадлежащих <img src="https://latex.codecogs.com/gif.latex?\dot{U}(x_{0},\delta&space;_{\varepsilon&space;})" title="\dot{U}(x_{0},\delta _{\varepsilon })" />,  и <img src="https://latex.codecogs.com/gif.latex?x''" title="x''" />, принадлежащих <img src="https://latex.codecogs.com/gif.latex?\dot{U}(x_{0},\delta&space;_{0})" title="\dot{U}(x_{0},\delta _{0})" /> , из этой окрестности, выполнялось неравенство:</div>
        <div><img src="https://latex.codecogs.com/gif.latex?\left&space;|&space;f(x')-f(x'')\right&space;|<&space;\varepsilon" title="\left | f(x')-f(x'')\right |< \varepsilon" /></div>
            </body>
</div>
</div>
