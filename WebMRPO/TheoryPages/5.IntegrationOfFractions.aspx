        ...
        <div id="workspace">
            ...
            <div id="content">
               ...
               <p align="justify">
                   ...
                   переменной х и постоянных, используя основные арифметические операции.</p>
                 ...
                 <br align="justify"><u> Например:</u> </br>
                     <a><img src="https://latex.codecogs.com/gif.latex?R(x)=5\cdot&space;x&plus;3-\frac{x}{x^{2}&plus;5}" title="R(x)=5\cdot x+3-\frac{x}{x^{2}+5}" /></a>    
                <p align="justify">
                        <span style="color: chocolate"><em>Рациональная функция (дробь)</em></span>  <img src="https://latex.codecogs.com/gif.latex?R(x)=\frac{P(x)}{Q(x)}" title="R(x)=\frac{P(x)}{Q(x)}" /> называется 
                    <span style="color: chocolate"><em>правильной</em></span>, если степень числителя меньше степени знаменателя. В противном случае рациональная функция называется неправильной.</p>
                    ...
                    <p align="justify"> Число а называется
                        <span style="color: chocolate"><em>корнем многочлена</em></span> <img src="https://latex.codecogs.com/gif.latex?Q(x)" title="Q(x)" /> кратности <img src="https://latex.codecogs.com/gif.latex?\alpha" title="\alpha" />, если 
                        этот многочлен можно представить в виде : <img src="https://latex.codecogs.com/gif.latex?Q(x)=(x-a)^{\alpha&space;}\cdot&space;q(x),&space;q(a)\neq&space;0" title="Q(x)=(x-a)^{\alpha }\cdot q(x), q(a)\neq 0" /></p>
                    <a><u>Например</u> для многочлена <img src="https://latex.codecogs.com/gif.latex?Q(x)=x^{3}&plus;x^{2}=x^{2}\cdot&space;(x&plus;1)=(x-0)^{2}\cdot&space;(x&plus;1)" title="Q(x)=x^{3}+x^{2}=x^{2}\cdot (x+1)=(x-0)^{2}\cdot (x+1)" />, корнем кратности два является число 0, а корнем кратности 1 
                        - число -1.</a>
                    <p align="justify"><b><span style="color: brown">Теорема №1</span></b>: всякий многочлен, старший коэффициент которого равен единице, с действительными коэффициентами 
                        можно представить в виде <img src="https://latex.codecogs.com/gif.latex?Q(x)=&space;(x-a_{1})^{\alpha&space;_{1}}\cdot&space;(x-a_{2})^{\alpha&space;_{2}}\cdot&space;...\cdot&space;(x-a_{k})^{\alpha&space;_{k}}\cdot&space;(x^{2}&plus;p_{1}x&plus;q_{1})^{\beta&space;_{1}}\cdot&space;(x^{2}&plus;p_{2}x&plus;q_{2})^{\beta&space;_{2}}\cdot&space;...\cdot&space;(x^{2}&plus;p_{m}x&plus;q_{m})^{\beta&space;_{m}}" title="Q(x)= (x-a_{1})^{\alpha _{1}}\cdot (x-a_{2})^{\alpha _{2}}\cdot ...\cdot (x-a_{k})^{\alpha _{k}}\cdot (x^{2}+p_{1}x+q_{1})^{\beta _{1}}\cdot (x^{2}+p_{2}x+q_{2})^{\beta _{2}}\cdot ...\cdot (x^{2}+p_{m}x+q_{m})^{\beta _{m}}" /> (*),
                         где <img src="https://latex.codecogs.com/gif.latex?a_{1},a_{2}...a_{k}" title="a_{1},a_{2}...a_{k}" /> - различные действительные корни многочлена кратности <img src="https://latex.codecogs.com/gif.latex?\alpha&space;_{1},\alpha&space;_{2}...\alpha&space;_{k}" title="\alpha _{1},\alpha _{2}...\alpha _{k}" />
                        соответственно, а каждый их кратных трехчленов не имеет действительных корней. </p>
                     <p align="justify"><b><span style="color: brown">Теорема №2</span></b>: пусть дробь <img src="https://latex.codecogs.com/gif.latex?R(x)=\frac{P(x)}{Q(x)}" title="R(x)=\frac{P(x)}{Q(x)}" /> является правильной, знаменатель которой представим в виде (*), тогда для этой дроби справедливо представление в виде:
                    <img src="https://latex.codecogs.com/gif.latex?R(x)=\frac{A_{11}}{x-a_{1}}&plus;\frac{A_{12}}{(x-a_{1})^{2}}&plus;...&plus;\frac{A_{1\alpha&space;_1}}{(x-a_{1})^{\alpha&space;_{1}}}&plus;\frac{A_{21}}{x-a_{2}}&plus;\frac{A_{22}}{(x-a_{2})^{2}}&plus;...&plus;\frac{A_{2\alpha&space;_{2}}}{(x-a_{2})^{\alpha&space;_{2}}}&plus;...&plus;\frac{A_{k1}}{x-a_{k}}&plus;\frac{A_{k2}}{(x-a_{k})^{2}}&plus;...&plus;\frac{A_{k\alpha&space;_{k}}}{(x-a_{k})^{\alpha&space;_{k}}}&plus;\frac{M_{11}x&plus;N_{11}}{x^{2}&plus;p_{1}x&plus;q_{1}}&plus;\frac{M_{12}x&plus;N_{12}}{(x^{2}&plus;p_{1}x&plus;q_{1})^{2}}&plus;...&plus;\frac{M_{1\beta&space;_{1}}x&plus;N_{1\beta&space;_{1}}}{(x^{2}&plus;p_{1}x&plus;q_{1})^{\beta&space;_{1}}}&plus;...&plus;\frac{M_{l1}x&plus;N_{l1}}{x^{2}&plus;p_{l}x&plus;q_{l}}&plus;\frac{M_{l2}x&plus;N_{l2}}{(x^{2}&plus;p_{l}x&plus;q_{l})^{2}}&plus;...&plus;\frac{M_{l\beta&space;_{l}x&plus;N_{l\beta&space;_{l}}}}{(x^{2}&plus;p_{l}x&plus;q_{l})^{\beta&space;_{l}}}&space;,&space;A_{11},A_{12},...,M_{11},...,N_{11},...&space;\in&space;\mathbb{R}" title="R(x)=\frac{A_{11}}{x-a_{1}}+\frac{A_{12}}{(x-a_{1})^{2}}+...+\frac{A_{1\alpha _1}}{(x-a_{1})^{\alpha _{1}}}+\frac{A_{21}}{x-a_{2}}+\frac{A_{22}}{(x-a_{2})^{2}}+...+\frac{A_{2\alpha _{2}}}{(x-a_{2})^{\alpha _{2}}}+...+\frac{A_{k1}}{x-a_{k}}+\frac{A_{k2}}{(x-a_{k})^{2}}+...+\frac{A_{k\alpha _{k}}}{(x-a_{k})^{\alpha _{k}}}+\frac{M_{11}x+N_{11}}{x^{2}+p_{1}x+q_{1}}+\frac{M_{12}x+N_{12}}{(x^{2}+p_{1}x+q_{1})^{2}}+...+\frac{M_{1\beta _{1}}x+N_{1\beta _{1}}}{(x^{2}+p_{1}x+q_{1})^{\beta _{1}}}+...+\frac{M_{l1}x+N_{l1}}{x^{2}+p_{l}x+q_{l}}+\frac{M_{l2}x+N_{l2}}{(x^{2}+p_{l}x+q_{l})^{2}}+...+\frac{M_{l\beta _{l}x+N_{l\beta _{l}}}}{(x^{2}+p_{l}x+q_{l})^{\beta _{l}}} , A_{11},A_{12},...,M_{11},...,N_{11},... \in \mathbb{R}" /></p>
                          <p align="justify"> Дроби вида <img src="https://latex.codecogs.com/gif.latex?\frac{A}{x-a},\frac{A}{(x-a)^{\alpha&space;}},\frac{Mx&plus;N}{x^{2}&plus;px&plus;q}&space;,&space;\frac{Mx&plus;N}{(x^{2}&plus;px&plus;q)^{\beta&space;}}" title="\frac{A}{x-a},\frac{A}{(x-a)^{\alpha }},\frac{Mx+N}{x^{2}+px+q} , \frac{Mx+N}{(x^{2}+px+q)^{\beta }}" /> называются 
                        <span style="color: chocolate"><em> простейшими дробями 1 - 4 типов</em></span>.</p>
                   ...
                   <br><img src="https://latex.codecogs.com/gif.latex?\left\{\begin{matrix}&space;A&plus;C&plus;D&space;=&space;0\\&space;-A&plus;B-2C&plus;D=0&space;\\&space;-2A-B=1&space;\\&space;-2B=3&space;\end{matrix}\right.\rightarrow&space;\left\{\begin{matrix}&space;A=&space;\frac{1}{4}\\&space;B=-&space;\frac{3}{2}&space;\\&space;C=-\frac{2}{3}&space;\\&space;D=\frac{5}{12}&space;\end{matrix}\right." title="\left\{\begin{matrix} A+C+D = 0\\ -A+B-2C+D=0 \\ -2A-B=1 \\ -2B=3 \end{matrix}\right.\rightarrow \left\{\begin{matrix} A= \frac{1}{4}\\ B=- \frac{3}{2} \\ C=-\frac{2}{3} \\ D=\frac{5}{12} \end{matrix}\right." /></br>
                      <br> <img src="https://latex.codecogs.com/gif.latex?\frac{x&plus;3}{x^{2}\cdot&space;(x&plus;1)\cdot&space;(x-2)}=\frac{1}{4x}-\frac{3}{2x^{2}}-\frac{2}{3(x&plus;1)}&plus;\frac{5}{12(x-2)}" title="\frac{x+3}{x^{2}\cdot (x+1)\cdot (x-2)}=\frac{1}{4x}-\frac{3}{2x^{2}}-\frac{2}{3(x+1)}+\frac{5}{12(x-2)}" /></br>
