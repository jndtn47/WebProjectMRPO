                ...
                <div id="content">
                    ...
                    <div id="text">
                        <h4>Производная сложной функции</h4>
                            ...
                            <div>Степень вложенности определено любым натуральным числом и записывается как
                                <img src="https://latex.codecogs.com/gif.latex?y=f(f_{1}(f_{2}(f_{3})(...(f_{n}(x))))))" title="y=f(f_{1}(f_{2}(f_{3})(...(f_{n}(x))))))" />.</div>
                            ...
                            <div>
                                <img src="https://latex.codecogs.com/gif.latex?(f(g(x)))'=f'(g(x))*g'(x)" title="(f(g(x)))'=f'(g(x))*g'(x)" /></div>
