...
<body>
    <form id="form1" runat="server">
        <div id="workspace">
            ...
            <div id="content">
                ...
                <div id="text">
                    ...
                    <p aling="justify">В данном случае началом отрезка является точка
                        ...
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{AB}" title="\overrightarrow{AB}" />.</p>
                    <p aling="justify">Направление имеет существенное значение, если переставить стрелку в другой конец отрезка, то получится вектор
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{BA}" title="\overrightarrow{BA}" />, и это уже совершенно другой вектор. Понятие вектора удобно отождествлять с движением физического тела: согласитесь, зайти в двери института или выйти из дверей института – это совершенно разные вещи.</p>
                    <p aling="justify">Отдельные точки плоскости, пространства удобно считать так называемым нулевым вектором
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{O}" title="\overrightarrow{O}" />. У такого вектора конец и начало совпадают.</p>
                    <p aling="justify"><i>Длиной</i> или <i>модулем</i> ненулевого вектора
                        ...
                        равна нулю.</p>
                    <p aling="justify">Длина вектора обозначается знаком модуля:
                        <img src="https://latex.codecogs.com/gif.latex?|\overrightarrow{AB}|" title="|\overrightarrow{AB}|" />.</p>
                    ...
                    <p aling="justify">Рассмотрим два произвольных ненулевых вектора
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{a}" title="\overrightarrow{a}" />
                        и
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{b}" title="\overrightarrow{b}" />:</p>
                    <center><img aling="center" src="../resources/Vector/Vector3.png" width="30%" /></center>
                    <p aling="justify">Требуется найти сумму данных векторов. В силу того, что все векторы считаются свободными, отложим вектор
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{b}" title="\overrightarrow{b}" />
                        от конца вектора
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{a}" title="\overrightarrow{a}" />:</p>
                    ...
                    <p aling="justify">Кстати, если вектор
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{b}" title="\overrightarrow{b}" />
                        отложить от начала вектора
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{a}" title="\overrightarrow{a}" />, то получится эквивалентное <i>правило параллелограмма</i> сложения векторов.</p>
       ...
       <img src="https://latex.codecogs.com/gif.latex?|\lambda|" title="|\lambda|" />
                    ...
                    <p aling="justify">Первым пунктом рассмотрим векторы на плоскости. Изобразим декартову прямоугольную систему координат и от начала координат отложим единичные векторы
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{i}" title="\overrightarrow{i}" />
                        и
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{j}" title="\overrightarrow{j}" /></p>
                    <center><img aling="center" src="../resources/Vector/Vektor6.PNG" width="30%" /></center>
                    <p aling="justify">Векторы
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{i}" title="\overrightarrow{i}" />
                        и
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{j}" title="\overrightarrow{j}" />
                        ортогональны. Ортогональны = Перпендикулярны. </p>
                    <p aling="justify"><b>Обозначение</b>: ортогональность векторов записывают привычным значком перпендикулярности, например:
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{i}\perp\overrightarrow{j}" title="\overrightarrow{i}\perp\overrightarrow{j}" /></p>
                    ...
                    <p aling="justify">Если даны две точки плоскости <i>A(x<sub>1</sub>,y<sub>1</sub>)</i> и <i>B(x<sub>2</sub>,y<sub>2</sub>)</i>, то вектор
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{AB}" title="\overrightarrow{AB}" />
                        имеет следующие координаты:
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{AB}" title="\overrightarrow{AB}" /><i>(x<sub>2</sub>-x<sub>1</sub>,y<sub>2</sub>-y<sub>1</sub>)</i></p>
                    <p aling="justify">То есть, из координат конца вектора нужно вычесть соответствующие координаты начала вектора.</p>
                    <p aling="justify"><u>Пример 1.</u>  Даны две точки плоскости <i>A(2,1)</i> и <i>B(-2,3)</i>. Найти координаты вектора
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{AB}" title="\overrightarrow{AB}" /></p>
                    <p aling="justify"><b>Решение:</b> по соответствующей формуле:
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{AB}" title="\overrightarrow{AB}" />(-2-2,3-1)=<img src="https://latex.codecogs.com/gif.latex?\overrightarrow{AB}" title="\overrightarrow{AB}" />(-4,2)</p>
                    <center><img src="../resources/Vector/Vektor9.PNG" /></center>
                    <h3 align="center"><b>Как найти длину вектора?</b></h3>
                    <p aling="justify">Если даны две точки плоскости <i>A(x<sub>1</sub>,y<sub>1</sub>)</i> и <i>B(x<sub>2</sub>,y<sub>2</sub>)</i>, то длину отрезка <i>AB</i> можно вычислить по формуле
                        <img src="https://latex.codecogs.com/gif.latex?|AB|=\sqrt{(x_{2}-x_{1})^{2}&plus;(y_{2}-y_{1})^{2}}" title="|AB|=\sqrt{(x_{2}-x_{1})^{2}+(y_{2}-y_{1})^{2}}" /></p>
                    <p aling="justify"><b>Примечание:</b> Формулы останутся корректными, если переставить местами соответствующие координаты</p>
                    <p aling="justify"><u>Пример 2.</u>  Даны две точки плоскости <i>A(-3,5)</i> и <i>B(1,-3)</i>. Найти длину вектора
                        <img src="https://latex.codecogs.com/gif.latex?\overrightarrow{AB}" title="\overrightarrow{AB}" /></p>
                    <p aling="justify"><b>Решение:</b> по соответствующей формуле:
                        <img src="https://latex.codecogs.com/gif.latex?|AB|=\sqrt{(1-(-3))^{2}&plus;(-3-5)^{2}}=\sqrt{80}=4\sqrt{5}" title="|AB|=\sqrt{(1-(-3))^{2}+(-3-5)^{2}}=\sqrt{80}=4\sqrt{5}" /></p>
