                ...
                <div id="content">
                    ...
                    <div id="text">
                        <body>
                            ...
                            <div>
                                Если функция f(x) являются бесконечно большой при
                            ...
                            <div>
                                <img src="https://latex.codecogs.com/gif.latex?\frac{1}{\propto&space;}=0,&space;\frac{1}{0}=\propto" title="\frac{1}{\propto }=0, \frac{1}{0}=\propto" />
                            </div>
                            <div>
                                Если бесконечно малая функция имеет определенный знак при
                                <img src="https://latex.codecogs.com/gif.latex?\lim_{x\rightarrow&space;x_{0}}f(x)=0" title="\lim_{x\rightarrow x_{0}}f(x)=0" />, то есть положительна (или отрицательна) на некоторой проколотой окрестности точки x0, то этот факт можно выразить так:
                            </div>
                            <div>
                                <img src="https://latex.codecogs.com/gif.latex?\lim_{x\rightarrow&space;x_{0}}\alpha&space;(x)=&plus;0&space;(\lim_{x\rightarrow&space;x_{0}}\alpha&space;(x)=-0)" title="\lim_{x\rightarrow x_{0}}\alpha (x)=+0 (\lim_{x\rightarrow x_{0}}\alpha (x)=-0)" />
                            </div>
                            <div>
                                Точно также если бесконечно большая функция имеет определенный знак при
                                <img src="https://latex.codecogs.com/gif.latex?\lim_{x\rightarrow&space;x_{0}}f(x)=0" title="\lim_{x\rightarrow x_{0}}f(x)=0" />, то пишут:
                            </div>
                            <div>
                                <img src="https://latex.codecogs.com/gif.latex?\lim_{x\rightarrow&space;x_{0}}f(x)=&plus;\propto(\lim_{x\rightarrow&space;x_{0}}f(x)=-\propto)" title="\lim_{x\rightarrow x_{0}}f(x)=+\propto(\lim_{x\rightarrow x_{0}}f(x)=-\propto)" />
                            </div>
                            ...
                            <div>
                                <img src="../resources/RelationShip/Снимок.PNG" />
                            </div>
                        </body>
                    </div>
                </div>
